...
module Data.IoK8sApiAppsV1DeploymentStatus exposing (IoK8sApiAppsV1DeploymentStatus, ioK8sApiAppsV1DeploymentStatusDecoder, ioK8sApiAppsV1DeploymentStatusEncoder)

import Data.IoK8sApiAppsV1DeploymentCondition exposing (IoK8sApiAppsV1DeploymentCondition, ioK8sApiAppsV1DeploymentConditionDecoder, ioK8sApiAppsV1DeploymentConditionEncoder)
...
type alias IoK8sApiAppsV1DeploymentStatus =
    { availableReplicas : Maybe Int
    , collisionCount : Maybe Int
    , conditions : Maybe (List IoK8sApiAppsV1DeploymentCondition)
...
ioK8sApiAppsV1DeploymentStatusDecoder : Decoder IoK8sApiAppsV1DeploymentStatus
ioK8sApiAppsV1DeploymentStatusDecoder =
    decode IoK8sApiAppsV1DeploymentStatus
        |> optional "availableReplicas" (Decode.nullable Decode.int) Nothing
        |> optional "collisionCount" (Decode.nullable Decode.int) Nothing
        |> optional "conditions" (Decode.nullable (Decode.list ioK8sApiAppsV1DeploymentConditionDecoder)) Nothing
...
ioK8sApiAppsV1DeploymentStatusEncoder : IoK8sApiAppsV1DeploymentStatus -> Encode.Value
ioK8sApiAppsV1DeploymentStatusEncoder model =
    Encode.object
        ...
        , ( "conditions", withDefault Encode.null (map (Encode.list << List.map ioK8sApiAppsV1DeploymentConditionEncoder) model.conditions) )
