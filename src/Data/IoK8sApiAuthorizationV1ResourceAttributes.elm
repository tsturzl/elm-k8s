...
module Data.IoK8sApiAuthorizationV1ResourceAttributes exposing (IoK8sApiAuthorizationV1ResourceAttributes, ioK8sApiAuthorizationV1ResourceAttributesDecoder, ioK8sApiAuthorizationV1ResourceAttributesEncoder)
...
type alias IoK8sApiAuthorizationV1ResourceAttributes =
    { group : Maybe String
    , name : Maybe String
...
ioK8sApiAuthorizationV1ResourceAttributesDecoder : Decoder IoK8sApiAuthorizationV1ResourceAttributes
ioK8sApiAuthorizationV1ResourceAttributesDecoder =
    decode IoK8sApiAuthorizationV1ResourceAttributes
...
ioK8sApiAuthorizationV1ResourceAttributesEncoder : IoK8sApiAuthorizationV1ResourceAttributes -> Encode.Value
ioK8sApiAuthorizationV1ResourceAttributesEncoder model =
    Encode.object
