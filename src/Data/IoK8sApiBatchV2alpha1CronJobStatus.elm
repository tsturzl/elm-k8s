...
module Data.IoK8sApiBatchV2alpha1CronJobStatus exposing (IoK8sApiBatchV2alpha1CronJobStatus, ioK8sApiBatchV2alpha1CronJobStatusDecoder, ioK8sApiBatchV2alpha1CronJobStatusEncoder)
...
type alias IoK8sApiBatchV2alpha1CronJobStatus =
    { active : Maybe (List IoK8sApiCoreV1ObjectReference)
    , lastScheduleTime : Maybe IoK8sApimachineryPkgApisMetaV1Time
    }


ioK8sApiBatchV2alpha1CronJobStatusDecoder : Decoder IoK8sApiBatchV2alpha1CronJobStatus
ioK8sApiBatchV2alpha1CronJobStatusDecoder =
    decode IoK8sApiBatchV2alpha1CronJobStatus
...
ioK8sApiBatchV2alpha1CronJobStatusEncoder : IoK8sApiBatchV2alpha1CronJobStatus -> Encode.Value
ioK8sApiBatchV2alpha1CronJobStatusEncoder model =
    Encode.object
