...
module Data.IoK8sApiRbacV1ClusterRole exposing (IoK8sApiRbacV1ClusterRole, ioK8sApiRbacV1ClusterRoleDecoder, ioK8sApiRbacV1ClusterRoleEncoder)

import Data.IoK8sApiRbacV1AggregationRule exposing (IoK8sApiRbacV1AggregationRule, ioK8sApiRbacV1AggregationRuleDecoder, ioK8sApiRbacV1AggregationRuleEncoder)
...
type alias IoK8sApiRbacV1ClusterRole =
    { aggregationRule : Maybe IoK8sApiRbacV1AggregationRule
...
ioK8sApiRbacV1ClusterRoleDecoder : Decoder IoK8sApiRbacV1ClusterRole
ioK8sApiRbacV1ClusterRoleDecoder =
    decode IoK8sApiRbacV1ClusterRole
        |> optional "aggregationRule" (Decode.nullable ioK8sApiRbacV1AggregationRuleDecoder) Nothing
...
ioK8sApiRbacV1ClusterRoleEncoder : IoK8sApiRbacV1ClusterRole -> Encode.Value
ioK8sApiRbacV1ClusterRoleEncoder model =
    Encode.object
        [ ( "aggregationRule", withDefault Encode.null (map ioK8sApiRbacV1AggregationRuleEncoder model.aggregationRule) )
