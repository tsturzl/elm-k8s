...
module Data.IoK8sApiRbacV1RoleList exposing (IoK8sApiRbacV1RoleList, ioK8sApiRbacV1RoleListDecoder, ioK8sApiRbacV1RoleListEncoder)
...
type alias IoK8sApiRbacV1RoleList =
    { apiVersion : Maybe String
    , items : (List IoK8sApiRbacV1Role)
    , kind : Maybe String
    , metadata : Maybe IoK8sApimachineryPkgApisMetaV1ListMeta
    }


ioK8sApiRbacV1RoleListDecoder : Decoder IoK8sApiRbacV1RoleList
ioK8sApiRbacV1RoleListDecoder =
    decode IoK8sApiRbacV1RoleList
        |> optional "apiVersion" (Decode.nullable Decode.string) Nothing
        |> required "items" (Decode.list ioK8sApiRbacV1RoleDecoder)
...
ioK8sApiRbacV1RoleListEncoder : IoK8sApiRbacV1RoleList -> Encode.Value
ioK8sApiRbacV1RoleListEncoder model =
    Encode.object
        [ ( "apiVersion", withDefault Encode.null (map Encode.string model.apiVersion) )
        , ( "items", (Encode.list << List.map ioK8sApiRbacV1RoleEncoder) model.items )
