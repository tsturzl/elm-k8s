...
module Data.IoK8sApiRbacV1beta1ClusterRole exposing (IoK8sApiRbacV1beta1ClusterRole, ioK8sApiRbacV1beta1ClusterRoleDecoder, ioK8sApiRbacV1beta1ClusterRoleEncoder)

import Data.IoK8sApiRbacV1beta1AggregationRule exposing (IoK8sApiRbacV1beta1AggregationRule, ioK8sApiRbacV1beta1AggregationRuleDecoder, ioK8sApiRbacV1beta1AggregationRuleEncoder)
...
type alias IoK8sApiRbacV1beta1ClusterRole =
    { aggregationRule : Maybe IoK8sApiRbacV1beta1AggregationRule
...
ioK8sApiRbacV1beta1ClusterRoleDecoder : Decoder IoK8sApiRbacV1beta1ClusterRole
ioK8sApiRbacV1beta1ClusterRoleDecoder =
    decode IoK8sApiRbacV1beta1ClusterRole
        |> optional "aggregationRule" (Decode.nullable ioK8sApiRbacV1beta1AggregationRuleDecoder) Nothing
...
ioK8sApiRbacV1beta1ClusterRoleEncoder : IoK8sApiRbacV1beta1ClusterRole -> Encode.Value
ioK8sApiRbacV1beta1ClusterRoleEncoder model =
    Encode.object
        [ ( "aggregationRule", withDefault Encode.null (map ioK8sApiRbacV1beta1AggregationRuleEncoder model.aggregationRule) )
