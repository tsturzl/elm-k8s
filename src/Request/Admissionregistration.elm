...
module Request.Admissionregistration exposing (getAdmissionregistrationAPIGroup)
...
-}
getAdmissionregistrationAPIGroup : Http.Request IoK8sApimachineryPkgApisMetaV1APIGroup
getAdmissionregistrationAPIGroup =
    { method = "GET"
    , url = basePath ++ "/apis/admissionregistration.k8s.io/"
    , headers = []
    , body = Http.emptyBody
