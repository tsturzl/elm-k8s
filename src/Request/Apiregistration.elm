...
module Request.Apiregistration exposing (getApiregistrationAPIGroup)
...
-}
getApiregistrationAPIGroup : Http.Request IoK8sApimachineryPkgApisMetaV1APIGroup
getApiregistrationAPIGroup =
    { method = "GET"
    , url = basePath ++ "/apis/apiregistration.k8s.io/"
    , headers = []
    , body = Http.emptyBody
