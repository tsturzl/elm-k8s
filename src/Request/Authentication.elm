...
module Request.Authentication exposing (getAuthenticationAPIGroup)
...
-}
getAuthenticationAPIGroup : Http.Request IoK8sApimachineryPkgApisMetaV1APIGroup
getAuthenticationAPIGroup =
    { method = "GET"
    , url = basePath ++ "/apis/authentication.k8s.io/"
    , headers = []
    , body = Http.emptyBody
