...
module Request.Authorization exposing (getAuthorizationAPIGroup)
...
-}
getAuthorizationAPIGroup : Http.Request IoK8sApimachineryPkgApisMetaV1APIGroup
getAuthorizationAPIGroup =
    { method = "GET"
    , url = basePath ++ "/apis/authorization.k8s.io/"
    , headers = []
    , body = Http.emptyBody
