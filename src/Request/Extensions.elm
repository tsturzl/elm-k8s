...
module Request.Extensions exposing (getExtensionsAPIGroup)
...
-}
getExtensionsAPIGroup : Http.Request IoK8sApimachineryPkgApisMetaV1APIGroup
getExtensionsAPIGroup =
    { method = "GET"
    , url = basePath ++ "/apis/extensions/"
    , headers = []
    , body = Http.emptyBody
