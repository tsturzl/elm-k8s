...
module Request.Networking exposing (getNetworkingAPIGroup)
...
-}
getNetworkingAPIGroup : Http.Request IoK8sApimachineryPkgApisMetaV1APIGroup
getNetworkingAPIGroup =
    { method = "GET"
    , url = basePath ++ "/apis/networking.k8s.io/"
    , headers = []
    , body = Http.emptyBody
