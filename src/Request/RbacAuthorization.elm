...
module Request.RbacAuthorization exposing (getRbacAuthorizationAPIGroup)
...
-}
getRbacAuthorizationAPIGroup : Http.Request IoK8sApimachineryPkgApisMetaV1APIGroup
getRbacAuthorizationAPIGroup =
    { method = "GET"
    , url = basePath ++ "/apis/rbac.authorization.k8s.io/"
    , headers = []
    , body = Http.emptyBody
