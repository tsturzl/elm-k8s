...
module Request.Scheduling exposing (getSchedulingAPIGroup)
...
-}
getSchedulingAPIGroup : Http.Request IoK8sApimachineryPkgApisMetaV1APIGroup
getSchedulingAPIGroup =
    { method = "GET"
    , url = basePath ++ "/apis/scheduling.k8s.io/"
    , headers = []
    , body = Http.emptyBody
