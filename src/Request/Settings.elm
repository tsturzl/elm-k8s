...
module Request.Settings exposing (getSettingsAPIGroup)
...
-}
getSettingsAPIGroup : Http.Request IoK8sApimachineryPkgApisMetaV1APIGroup
getSettingsAPIGroup =
    { method = "GET"
    , url = basePath ++ "/apis/settings.k8s.io/"
    , headers = []
    , body = Http.emptyBody
