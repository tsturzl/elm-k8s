...
module Request.Storage exposing (getStorageAPIGroup)
...
-}
getStorageAPIGroup : Http.Request IoK8sApimachineryPkgApisMetaV1APIGroup
getStorageAPIGroup =
    { method = "GET"
    , url = basePath ++ "/apis/storage.k8s.io/"
    , headers = []
    , body = Http.emptyBody
